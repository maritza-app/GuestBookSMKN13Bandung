...
$ortu_query = mysqli_query($conn, "
    SELECT nama_ortu_wali, keperluan, tanggal_kunjungan_ow 
    FROM kunjungan_ortu_wali 
    ORDER BY tanggal_kunjungan_ow DESC 
    LIMIT 5
");
$instansi_query = mysqli_query($conn, "
    SELECT nama_pengunjung, nama_instansi, keperluan, tanggal_kunjungan_instansi 
    FROM kunjungan_instansi 
    ORDER BY tanggal_kunjungan_instansi DESC 
    LIMIT 5
");
$umum_query = mysqli_query($conn, "
    SELECT nama_pengunjung_umum, berkunjung_sebagai, keperluan, tanggal_kunjungan 
    FROM kunjungan_umum 
...
<!-- Template Stylesheet (custom kamu) -->
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <h1 class="mb-5">
                        <span class="text-uppercase text-primary bg-light px-2">About</span> of Our Aplication
                    </h1>
                    <p class="mb-4">
                        Guest Book 13 adalah aplikasi buku tamu digital yang bikin proses catat-mencatat mengenai
                        pengunjung sekolah jadi lebih gampang dan kekinian. Pengunjung tinggal isi data lewat layar,
                        langsung tersimpan rapi tanpa ribet nulis manual di buku atau kertas.
                    </p>
                    <p class="mb-5">
                        Selain praktis, Guest Book 13 juga bikin sekolah terlihat modern dan profesional. Data tamu aman,
                        gampang dicari, dan bisa diakses kapan aja lewat komputer atau HP. Simple, cepat, dan pastinya
                        lebih keren! 🚀
                    </p>
      ...
      <div class="card shadow border-0 h-100">
        <div class="card-body">
          ...
          <table class="table table-sm table-bordered text-center">
            ...
            <tbody>
              <?php if(mysqli_num_rows($ortu_query) > 0){ while($data = mysqli_fetch_assoc($ortu_query)){ ?>
              <tr>
      ...
      <div class="card shadow border-0 h-100">
        <div class="card-body">
          ...
          <table class="table table-sm table-bordered text-center">
            ...
            <tbody>
              <?php if(mysqli_num_rows($instansi_query) > 0){ while($data = mysqli_fetch_assoc($instansi_query)){ ?>
              <tr>
      ...
      <div class="card shadow border-0 h-100">
        <div class="card-body">
          ...
          <table class="table table-sm table-bordered text-center">
            ...
            <tbody>
              <?php if(mysqli_num_rows($umum_query) > 0){ while($data = mysqli_fetch_assoc($umum_query)){ ?>
              <tr>
    ...
    <div class="row g-5">
      ...
      <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.1s">
        ...
        <p class="mb-0">
          ...
          Lebih cepat, efisien, dan terjamin keamanannya. Saatnya tinggalkan cara lama, beralih ke yang lebih smart!
        </p>
      </div>
    ...
    <div class="copyright">
      <div class="row">
        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
          &copy; MFN Squad, All Right Reserved.
        </div>
      </div>
    </div>
  </div>
