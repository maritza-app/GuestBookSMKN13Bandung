...
<body>
 <nav class="navbar">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
           <center><h2 class="m-0" style="color: #a83232">Data Dokumentasi Kunjungan</h2></center>
        <a href="{{ route('dokumentasi.create') }}" class="btn-add mb-3">+ Tambah Data</a>
    </div>
        <br>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $row->id_dokumentasi }}</td>
                        <td>{{ $row->tanggal_kunjungan }}</td>
                        <td>{{ $row->nama_kegiatan }}</td>
                        <td>{{ $row->kategori_tamu }}</td>
                        <td>{{ $row->keterangan_tamu }}</td>
                        <td>{{ $row->keterangan_kegiatan }}</td>
                        <td>
                            <img src="{{ asset('imgdokumentasi/' . $row->dokumentasi) }}" alt="Dokumentasi" class="img-thumbnail" width="100">
                        </td>
                        <td>
                            <a href="{{ route('dokumentasi.edit', $row->id_dokumentasi) }}" class="btn-edit" style="margin-bottom: 10px;">🖊️ Edit</a>
                            <form action="{{ route('dokumentasi.destroy', $row->id_dokumentasi) }}" method="POST" style="display:inline;">
                                @csrf
                                @method('DELETE')
