...
<body>
   <nav class="navbar">
    ...
    <div class="layout-container">
        ...
        <h2>Laporan Data Kunjungan Umum</h2>
        <br>
<form id="filterForm" class="mb-3">
  <div class="row g-2">
    ...
    @endif
                            ...
                            <td>
                                @if($row->foto)
                                    <img src="{{ asset('imgumum/' . $row->foto) }}" alt="Foto" width="80">
                                @else
...
// 🔹 Custom Filter Bulan & Tahun
    $.fn.dataTable.ext.search.push(function (settings, data, dataIndex) {
        var bulan = $('#bulan').val();
        var tahun = $('#tahun').val();
        var tanggal = data[2] || ""; // kolom tanggal (index 2 → Tanggal Kunjungan)

        if (!tanggal) return false;

        if (bulan && tahun) {
            return tanggal.startsWith(tahun + "-" + bulan);
        } else if (tahun) {
